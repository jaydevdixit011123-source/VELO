...
function localReply(text) {
  ...
  if (t.includes('hello') || t.includes('hi') || t.includes('namaste') || t.includes('hii'))
    return 'Hello Jaydev! I am VELO, your personal AI assistant. How can I help you today?';
  if (t.includes('how are you')) return "I'm doing great, thanks for asking!";
  if (t.includes('your name')) return "I'm VELO - fast, free, and all yours.";
  ...
  return "I'm in offline local mode right now. Add a FREE Groq API key in Settings for full AI. Try: 'open notepad', 'show my notes', 'create reminder', 'screenshot'.";
}
